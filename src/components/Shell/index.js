    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="App-input">
          <label htmlFor="movieSearch" className={props.search ? 'label-top' : ''}>
            Movie Name
          </label>
          <input
            id="movieSearch"
            ...
            onKeyPress={e => props.onChangeSearch(e)}
          />
          <Link to={`/search/${props.search}`} className="searchButton">
      ...
      <div className="App-result">
        {showLoading}
        <div className="Movie-error"> {props.error} </div>
        <Switch>
